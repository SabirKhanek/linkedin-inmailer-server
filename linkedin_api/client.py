...
class Client(object):
    ...
    liTrackSales='{"clientVersion":"1.0.9095","mpVersion":"1.0.9095","osName":"web","mpName":"lighthouse-web","displayDensity":1.25,"displayWidth":1920,"displayHeight":1080}'
    liTrackVoyager='{"clientVersion":"0.0.0-productspec","mpVersion":"0.0.0-productspec","osName":"web","mpName":"voyager-web","displayDensity":1.25,"displayWidth":1920,"displayHeight":1080}'

    LINKEDIN_BASE_URL = "https://www.linkedin.com"
    SALES_NAV_BASE_URL = f"{LINKEDIN_BASE_URL}/sales"
    SALES_NAV_API_URL = f"{LINKEDIN_BASE_URL}/sales-api"
    ...
    def _fetch_metadata(self):
        ...
        """
        logger.debug("Fetching instance metadata")
    ...
    def _fetch_sales_nav_metadata(self):
        ...
        Store this data in self.metadata
        """
        logger.debug("Fetching sales nav instance metadata")
        res = requests.get(
            f"{Client.SALES_NAV_BASE_URL}",
            cookies=self.session.cookies,
            headers=Client.AUTH_REQUEST_HEADERS,
            proxies=self.proxies,
        )
        ...
        if clientApplicationInstanceRaw:
            ...
            clientApplicationInstance = json.loads(clientApplicationInstanceRaw)
            self.metadata["premium"]["clientApplicationInstance"] = clientApplicationInstance
        ...
        if clientPageInstanceIdRaw:
            clientPageInstanceId = clientPageInstanceIdRaw.attrs.get("content") or {}
            self.metadata["premium"]["clientPageInstanceId"] = clientPageInstanceId
